  ...
  async onPreBuild({ constants, utils }) {
    ...
    if (process.cwd() === constants.PUBLISH_DIR) {
      utils.build.failBuild(
        `Nuxt sites must publish the dist directory, but your site’s publish directory is set to “${constants.PUBLISH_DIR}”. Please set your publish directory to your Nuxt site’s dist directory.`,
      );
    }
